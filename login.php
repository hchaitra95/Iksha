...
<body>
  <div id="wrapper">
    ...
    <p class="text-center">
        <a href="#Studentlogin" data-toggle="modal"><button class="btn btn-large btn-theme margintop10" type="submit">Student Login</button></a>
                  </p>
                    <p class="text-center">
                        <a href="#Facultylogin" data-toggle="modal"><button class="btn btn-large btn-theme margintop10" type="submit">Faculty Login</button></a>
                  </p>
    
                  <div id="Studentlogin" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 id="mySigninModalLabel">Student <strong>Log in</strong></h4>
              </div>
              ...
              <div class="modal-body">
                <form class="form-horizontal">
                  <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="inputResetEmail" placeholder="Email" required/>
                    </div>
                  </div>
                  <div class="control-group">
                    <div class="controls">
                   ...
                   <div id="Facultylogin" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 id="mySigninModalLabel">Faculty <strong>Log in</strong></h4>
              </div>
              <div class="modal-body">
                  <form class="form-horizontal" method="post" action="login.php">
                  <div class="control-group">
                    <label class="control-label" for="inputText">Faculty ID</label>
                    <div class="controls">
                        <input type="text" id="inputText" placeholder="Faculty ID" name="fid" required/>
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    <div class="controls">
                        <button type="submit" name="login_faculty" class="btn">Log in</button>
                    </div>
