        ...
        <div class="row">
          <div class="span12">
            <div class="inner-heading">
              <h2>Welcome <?php print $faculty_first_name; echo '  '.$faculty_last_name.'';?></h2>
            </div>
              ...
              <tbody>
                ...
                <tr class="success">
                  ...
                  <td>
                    ...
                    <p class="text-center">
                        <a href="material.php"><button class="btn btn-large btn-theme btn-rounded" type="submit">Upload Material</button></a>
                </p>
                <p class="text-center">
                        <a href="syllabus.php"><button class="btn btn-large btn-theme btn-rounded" type="submit">Upload Syllabus</button></a>
                </p>
         ...
         <div id="update" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                  <form class="form-horizontal" method="post" action="facultydashboard.php">
                    ...
                    <div class="controls">
                        <input type="text" value="<?php print $faculty_first_name;?>"  name="faculty_first_name"/>
                    </div>
                  </div>
                      <div class="control-group">
                    <label class="control-label">Last Name</label>
                    <div class="controls">
                        <input type="text" value="<?php print $faculty_last_name;?>"  name="faculty_last_name"/>
                    </div>
                  </div>
                    ...
                    <div class="controls">
                        <input type="text" value="<?php print $designation;?>" name="fdesgn" />
                    </div>
                      </div>
                       <div class="control-group">
                    <label class="control-label">Qualification</label>
                    <div class="controls">
                        <input type="text" value="<?php print $qualification;?>" name="fquali"/>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">Email</label>
                    <div class="controls">
                        <input type="text" value="<?php print $femail;?>" name="femail" />
                    </div>
                  </div>
              <div class="control-group">
                    <div class="controls">
          ...
          <div id="changepassword" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                  ...
                  <div class="control-group">
                    <div class="controls">
                        <button type="submit" class="btn" name="fchange">Change</button>
                    </div>
