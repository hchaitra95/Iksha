        ...
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2>Semester <?php print $sem; ?></h2>
            </div>
          </div>
          <div class="span8">
            <ul class="breadcrumb">
              <li><a href="#"><i class="icon-home"></i></a><i class="icon-angle-right"></i></li>
              <li><a href="#">Downloads</a><i class="icon-angle-right"></i></li>
              <li><a href="manual.php">Lab Manuals</a><i class="icon-angle-right"></i></li>
               <li class="active">Semester <?php print $sem; ?></li>
        ...
        <div class="container">
            ...
            <div class="span11">
                    <div class="text-center">
                        <h4><strong>Semester <?php print $sem; ?> Lab Manual</strong></h4>
                    </div>
              ...
              <tbody>
                  <tr>
                      ...
                      <td>
                          <a href="<?php print($syll1['URL']);?> " target="_blank">Download</a>
                      </td>
                      <td>
                          <a href="<?php print($manual1['URL']);?> " target="_blank">Download</a>
                      </td>
                  </tr>
                  <tr>
                      <td>
                      ...
                      <td>
                          <a href="<?php print($syll2['URL']);?> " target="_blank">Download</a>
                      </td>
                      <td>
                          <a href="<?php print($manual2['URL']);?> " target="_blank">Download</a>
                      </td>
                  </tr>
              </tbody>
              </table>
