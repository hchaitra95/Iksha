        ...
        <div class="row">
          <div class="span12">
            <div class="inner-heading">
                <h2>Welcome <?php print $user_first_name; echo ' '.$user_last_name.'';?></h2>
            </div>
        ...
        <div class="span9">
         ...
         <div id="update" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                  <form class="form-horizontal" method="post" action="studentdashboard.php">
                                       
                                 <div class="control-group">
                    <label class="control-label">USN</label>
                    <div class="controls">
                        <input type="text" value="<?php print $usn;?>"  name="usn"/>
                    </div>
                  </div><div class="control-group">
                    <label class="control-label">First Name</label>
                    <div class="controls">
                        <input type="text" value="<?php print $user_first_name;?>"  name="user_first_name"/>
                    </div>
                  </div>
                    ...
                    <div class="controls">
                        <input type="text" value="<?php print $user_last_name;?>" name="user_last_name" />
                    </div>
                      </div>
              ...
              <div class="control-group">
                    <div class="controls">
                <button type="submit" class="btn" name="s_update">Update</button>
                    </div>
          ...
          <div id="changepassword" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                  ...
                  <div class="control-group">
                    <div class="controls">
                        <button type="submit" class="btn" name="uchange">Change</button>
                    </div>
