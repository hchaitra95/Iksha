...
<body>
  <div id="wrapper">
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Lab Manuals</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section id="content">
        <form method="post" action="manualdashboard.php">
        ...
        <h4>Choose Semester</h4>
         ...
         <h4>Choose Scheme</h4>
               ...
               <p class="text-center">
                  <button class="btn btn-large btn-theme margintop10" type="submit" name="get_sem">Submit</button>
                  </p>
