        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li>Downloads<i class="icon-angle-right"></i>Notes<i class="icon-angle-right"></i><?php print $subcode;?></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="container">
                ...
                <div class="span11">
                    <div class="text-center">
                        <h4><strong><?php print $subname;?></strong></h4>
                    </div>
            ...
            <table class="table table-bordered">
                   ...
                   <tr>
                    ...
                    <td colspan="2" ><a href="<?php print($syll['URL']);?> " target="_blank">Download</a></td>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                      <a href="<?php print($module1['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                    <a href="<?php print($bank1['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                      <a href="<?php print($a1['URL']);?> " target="_blank">Download</a>
                  </td>
                </tr>
                <tr>
                   <td>
                  ...
                  <td>
                   <a href="<?php print($module2['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                    <a href="<?php print($bank2['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                      <a href="<?php print($a2['URL']);?> " target="_blank">Download</a>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <a href="<?php print($module3['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                    <a href="<?php print($bank3['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                      <a href="<?php print($a3['URL']);?> " target="_blank">Download</a>
                  </td>
                </tr>
                <tr>
                   <td>
                  ...
                  <td>
                    <a href="<?php print($module4['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                    <a href="<?php print($bank4['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                      <a href="<?php print($a4['URL']);?> " target="_blank">Download</a>
                  </td>
                </tr>
                <tr>
                   <td>
                  ...
                  <td>
                    <a href="<?php print($module5['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                    <a href="<?php print($bank5['URL']);?> " target="_blank">Download</a>
                  </td>
                  <td>
                      <a href="<?php print($a5['URL']);?> " target="_blank">Download</a>
                  </td>
                </tr>
