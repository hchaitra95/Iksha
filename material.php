...
<section id="content">
      <div class="container">
          ...
          <h2 class="aligncenter">Upload Material</h2>
          ...
          <form method="post" action="facultydashboard.php">
...
mysqli_close($db);
        ...
        ?>        <h4>Choose Material</h4>
         ...
         <h4>Module</h4>
               ...
               <h4>G-Drive Link</h4>
               <input type="text" placeholder="G-Drive Link"  name="link" required/>
                            
                       
                   
                    <p class="text-center">
                        <button class="btn btn-large btn-theme margintop10" type="submit" name="get_material">Upload</button>
                  </p>
